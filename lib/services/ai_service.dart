    ...
    try {
      ...
      final prompt = [
        Content.text(
          ...
          '2. If the weather is all clear, provide a green flag: ✅. If the weather is cautionary, provide a yellow flag: 🟨. If the weather is really bad, provide a red flag: 🚩.Provide the High and Low temperatures for the overall route, as well as the times for each.\n'
